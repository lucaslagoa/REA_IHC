...
func mensagem():
	...
	get_node("Resposta Charada/Responda").percent_visible=1
...
func desabilitar_botao(raiz):
	...
	var btn = get_node("/root/Forest/NPC2/Resposta Charada/"+raiz)
	var desabilitar = get_node("/root/Forest/NPC2/Resposta Charada")
